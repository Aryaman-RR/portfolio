...
export const myProjects = [
  {
    title: "MetaD3",
    desc: "MetaD3 is an advanced platform for visualizing and analyzing biopharma company data through interactive, insightful graphs.",
    subdesc:
    ...
    tags: [
      ...
      },
      {
        id: 2,
        name: "Node.js",
        path: import.meta.env.BASE_URL + "assets/icons/node-js-icon.svg",
      },
    ],
  },
  {
    title: "Asset42",
    desc: "Asset42 is a web app designed for pharmaceutical companies to visualize and evaluate drug assets based on financial opportunities.",
    subdesc:
